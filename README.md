[![Typing SVG](https://readme-typing-svg.herokuapp.com/?color=3da380&size=30&center=true&vCenter=true&width=1000&lines=Hello!+I+am+Ka%C3%ADque+Freire;Welcome+to+my+GitHub!)](https://git.io/typing-svg)

I am a Software Developer with experience in developing and maintaining ERP systems, mainly focused on backend development for enterprise applications.

Throughout my professional journey, I have worked with GeneXus, C#, and SQL Server, contributing to new features, APIs, system integrations, query optimization, and maintenance of applications used in enterprise environments. I have also worked on dashboard customization and solutions tailored to different business rules.

In recent months, I have been deepening my knowledge of Java and Spring Boot, studying software architecture, REST API development, software engineering best practices, and scalable application design.
